...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.AreEqual(form.NewPassword, form.NewPasswordConfirmation), "newPasswordConfirmation", "Passwords do not match")
	...
	if err := app.users.PasswordUpdate(userID, form.CurrentPassword, form.NewPassword); err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
